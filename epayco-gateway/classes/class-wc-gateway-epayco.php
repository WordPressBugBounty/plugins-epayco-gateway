...
class WC_Gateway_Epayco extends WC_Payment_Gateway
{
    ...
    public function __construct()
    {
        ...
        $this->method_description   = __('ePayco: Paga con Tarjeta de crédito/débito nacional e internacional, PSE, Daviplata, Nequi, PayPal, Efectivo, Safetypay y muchos más.', 'woo-epayco-gateway');
        ...
        function init_form_fields()
        {
            $this->form_fields = array(
                ...
                'title'            => array(
                    ...
                    'default'     => __('Pagar con ePayco', 'woo-epayco-gateway'),
                    'desc_tip'    => true,
                ),
                'description'      => array(
                    ...
                    'default'     => __('ePayco: Paga con Tarjeta de crédito/débito nacional e internacional, PSE, Daviplata, Nequi, PayPal, Efectivo, Safetypay y muchos más.', 'woo-epayco-gateway'),
                ),
